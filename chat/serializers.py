...
class ChatStatisticsSerializer(serializers.Serializer):
    ...
    def calculate_for_room(cls, room):
        """Delegate room statistics calculation to service layer."""
        from .services.statistics import calculate_for_room as svc
        return svc(room)
    
    @classmethod
    def calculate_global(cls):
        """Delegate global statistics calculation to service layer."""
        from .services.statistics import calculate_global as svc
        return svc()
